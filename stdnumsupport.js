 ...
 */
export default class stdnumsupport{
    ...
    mod11Checksum(s, regx, removeprefix) {
    ...
    eanChecksum(s, regx, removeprefix) {
        s = s.replace(/[#:\-\s\.]/g, "").replace(removeprefix, "");
     ...
     */
    isISBN (/**String*/s, /**Boolean*/ convertEANtoISBN) {
