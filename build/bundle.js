...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /*----------  Created by Neel Arora for the Libx Project  ----------*/
/*
...
var _stdnumsupport = __webpack_require__(3);

var _stdnumsupport2 = _interopRequireDefault(_stdnumsupport);

var _textTransformer = __webpack_require__(4);
...
var Amazon = function () {
	function Amazon() {
		...
		this.Num = new _stdnumsupport2.default();
	...
	_createClass(Amazon, [{
		key: 'fires',
		value: function fires() {
			var i = 0;
			for (var node in this.nodeList) {

				//nodeList[node] node with ISBN CHANGED
				var node = this.nodeList[node];
				var regexObj = this.regexObj;
				(0, _textTransformer2.default)({ node: node, regexObj: regexObj }).then(function (node) {
					var idString = '' + (new Date().valueOf() + Math.random() * 100);
					node.setAttribute("id", idString);
					console.log(node);
					(0, _toolTip2.default)(idString);
				}).catch(function (err) {
					console.log(err);
				});
			}
 ...
 *
  ...
  */
	...
	_createClass(Walker, [{
		key: 'registerPattern',
		value: function registerPattern(patternObj) {
			var _this = this;
			...
			return new Promise(function (fulfill, reject) {
				if (length + 1 == _this.apps.length) fulfill(true);else reject(false);
			});
		}
   ...
   */
		...
		key: 'initWalker',
		value: function initWalker() {
			var walker = document.createTreeWalker(window.document.documentElement, NodeFilter.SHOW_ALL, this.rejectScriptTextFilter, false);

			return new Promise(function (fulfill, reject) {
				if (walker) fulfill(walker);else reject('walker failed to init');
			});
		}
			...
			return this.initWalker().then(function (walker) {
				...
				while (walker.nextNode()) {
					if (walker.currentNode.nodeType == 3) {
						...
						try {
							for (var _iterator = self.apps[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
								var app = _step.value;
								...
								if (walker.currentNode.data) {
									var result = app.regex(walker.currentNode.data);
									if (result) {
				...
				return new Promise(function (fulfill, reject) {
					if (matches > 0) fulfill(true);else reject(false);
				});
			}).catch(function (err) {
				console.log(err);
			});
...
/**
 *
 * REGEX check functions FOR CHECKING ISBN, DOI, and phone numbers. ADAPTED FROM LIBX 2.0 SOURCE
 * ORGINIAL SRC/CORE/GLOBAL/LIBAPPS/STDNUMSUPPORT.JS
 */
/* ***** BEGIN LICENSE BLOCK *****
 * Version: MPL 1.1
 *
 ...
 */
var stdnumsupport = function () {
    function stdnumsupport() {
        _classCallCheck(this, stdnumsupport);
    }

    _createClass(stdnumsupport, [{
        key: "isDOI",
         ...
         */
        value: function isDOI( /**String */str) {
        ...
        key: "computeMod11CheckDigit",


        // compute the Mod 11 check digit, pass in string WITHOUT check digit
        value: function computeMod11CheckDigit(s) {
            var n = s.length;
            var chksum = 0;
            for (var i = 0; i < n; i++) {
        ...
        key: "mod11Checksum",
        value: function mod11Checksum(s, regx, removeprefix) {
            ...
            s = m[0];
            var n = s.length;
            var mustdigit = this.computeMod11CheckDigit(s.substring(0, n - 1));
        ...
        key: "eanChecksum",
        value: function eanChecksum(s, regx, removeprefix) {
            s = s.replace(/[#:\-\s\.]/g, "").replace(removeprefix, "");
        ...
        key: "isISBN",
        value: function isISBN( /**String*/s, /**Boolean*/convertEANtoISBN) {
            var ean = this.eanChecksum(s, /97[89]\d{10}/, /^ISBN/i);
            if (ean) {
                if (convertEANtoISBN) {
            ...
            return this.mod11Checksum(s, /\d{9}[\dX]/i, /^ISBN/i);
        }
        ...
        key: "isISSN",
        value: function isISSN( /**String*/s) {
    ...
    return stdnumsupport;
}();

exports.default = stdnumsupport;
 ...
 */
function tranformNodeAnchor(_ref) {
	var node = _ref.node,
	    regexObj = _ref.regexObj;

	var temp = document.createElement('div');
	var anchorNode = {};
	temp.innerHTML = node.data.replace(regexObj, '<a href="www.google.com">$&</a>');
	while (temp.firstChild) {
		if (temp.firstChild.nodeType == 1) anchorNode = temp.firstChild;
	...
	return new Promise(function (fulfill, reject) {
		//fulfill(nodes)
		if (anchorNode) fulfill(anchorNode);else reject('error splitting node');
	});
}

exports.default = tranformNodeAnchor;
...
var tooltipster = __webpack_require__(6)($);

function addToolTip(nodeName) {
    var $node = $("#" + nodeName);
    $node.tooltipster({
...
/*! tooltipster v4.2.3 */!function (a, b) {
  ...
  function b(a) {
    ...
    if (!g) return !1;var a = g.document.body || g.document.documentElement,
      ...
      h = { hasTouchCapability: !(!g || !("ontouchstart" in g || g.DocumentTouch && g.document instanceof g.DocumentTouch || g.navigator.maxTouchPoints)), hasTransitions: e(), IE: !1, semVer: "4.2.3", window: g },
      i = function i() {
    ...
    this.__callbacks = { close: [], open: [] }, this.__closingTime, this.__Content, this.__contentBcr, this.__destroyed = !1, this.__$emitterPrivate = a({}), this.__$emitterPublic = a({}), this.__enabled = !0, this.__garbageCollector, this.__Geometry, this.__lastPosition, this.__namespace = "tooltipster-" + Math.round(1e6 * Math.random()), this.__options, this.__$originParents, this.__pointerIsOverOrigin = !1, this.__previousThemes = [], this.__state = "closed", this.__timeouts = { close: [], open: null }, this.__touchEvents = [], this.__tracker = null, this._$origin, this._$tooltip, this.__init(b, c);
      ...
      var c = this;if (c.__options.triggerClose.scroll) c._close(b);else if (d(c._$origin) && d(c._$tooltip)) {
        if (b.target === h.window.document) c.__Geometry.origin.fixedLineage || c.__options.repositionOnScroll && c.reposition(b);else {
          var e = c.__geometry(),
              f = !1;if ("fixed" != c._$origin.css("position") && c.__$originParents.each(function (b, c) {
            var d = a(c),
                g = d.css("overflow-x"),
      ...
      var e = this,
        ...
        c && e.__callbacks.close.push(c), e.__callbacks.open = [], e.__timeoutsClear();var g = function g() {
          ...
          var i = !0,
              j = new Date(),
              k = j.getTime(),
              l = k + e.__options.animationDuration[1];if ("disappearing" == e.__state && l > e.__closingTime && (i = !1), i) {
      ...
      var b = this;if (b.__destroyed) b.__destroyError();else {
        "closed" != b.__state && b.option("animationDuration", 0)._close(null, null, !0), b._trigger("destroy"), b.__destroyed = !0, b._$origin.removeData(b.__namespace).off("." + b.__namespace + "-triggerOpen"), a(h.window.document.body).off("." + b.__namespace + "-triggerOpen");var c = b._$origin.data("tooltipster-ns");if (c) if (1 === c.length) {
...
throw new Error("Module build failed: Error: EINVAL: invalid argument, uv_interface_addresses\n    at Object.lib.networkInterfaces (/mnt/c/Users/ntarora/Desktop/libx-prototype/node_modules/macaddress/index.js:31:21)\n    at Object.lib.one (/mnt/c/Users/ntarora/Desktop/libx-prototype/node_modules/macaddress/index.js:79:26)\n    at Object.<anonymous> (/mnt/c/Users/ntarora/Desktop/libx-prototype/node_modules/uniqid/index.js:15:77)\n    at Module._compile (module.js:571:32)\n    at Object.Module._extensions..js (module.js:580:10)\n    at Module.load (module.js:488:32)\n    at tryModuleLoad (module.js:447:12)\n    at Function.Module._load (module.js:439:3)\n    at Module.require (module.js:498:17)\n    at require (internal/module.js:20:19)\n    at Object.<anonymous> (/mnt/c/Users/ntarora/Desktop/libx-prototype/node_modules/postcss-filter-plugins/dist/index.js:9:15)\n    at Module._compile (module.js:571:32)\n    at Object.Module._extensions..js (module.js:580:10)\n    at Module.load (module.js:488:32)\n    at tryModuleLoad (module.js:447:12)\n    at Function.Module._load (module.js:439:3)\n    at Module.require (module.js:498:17)\n    at require (internal/module.js:20:19)\n    at Object.<anonymous> (/mnt/c/Users/ntarora/Desktop/libx-prototype/node_modules/cssnano/dist/index.js:21:30)\n    at Module._compile (module.js:571:32)\n    at Object.Module._extensions..js (module.js:580:10)\n    at Module.load (module.js:488:32)\n    at tryModuleLoad (module.js:447:12)\n    at Function.Module._load (module.js:439:3)\n    at Module.require (module.js:498:17)\n    at require (internal/module.js:20:19)\n    at Object.<anonymous> (/mnt/c/Users/ntarora/Desktop/libx-prototype/node_modules/css-loader/lib/processCss.js:16:15)\n    at Module._compile (module.js:571:32)\n    at Object.Module._extensions..js (module.js:580:10)\n    at Module.load (module.js:488:32)");
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./node_modules/css-loader/index.js!./tooltipster.bundle.min.css", function() {
			var newContent = require("!!./node_modules/css-loader/index.js!./tooltipster.bundle.min.css");
...
var _Amazon = __webpack_require__(1);

var _Amazon2 = _interopRequireDefault(_Amazon);

var _walker = __webpack_require__(2);
...
*/
var apps = [_Amazon2.default];
var utils = [_walker2.default];
...
function load(apps, utils) {
	...
	try {
		var _loop = function _loop() {
			...
			if (app.matchPattern) {
				_walker2.default.registerPattern({ regex: app.regex, nodeList: app.nodeList }).then(function () {
	...
	_walker2.default.walkTree().then(function (nodeList) {
		//would be a for loop of 'apps'
		_Amazon2.default.fires(nodeList);
	}).catch(function (err) {
		console.log(err);
	});
}
